...
public class Process_patent {
	...
	public static String smo(String filename) throws Exception {
		...
		try {
			...
			File trainFinal=new File(absPathFile.getAbsolutePath()+prop.getProperty("NasaWorkingDirectory")+"train.arff");
			InputStream input5=	Process_patent.class.getResourceAsStream("/resources/"+"train.arff");
		...
		Probability_TopClass.probabilityCL();
