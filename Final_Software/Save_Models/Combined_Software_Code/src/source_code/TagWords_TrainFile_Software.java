...
public class TagWords_TrainFile_Software {
	...
	public static Map<Object, Set<String>> filter() throws Exception {
		...
		File file = new File(prop.getProperty("tagWordsTrainingFile_Software"));
		File file1=new File(absPathFile.getAbsolutePath() + prop.getProperty("NasaWorkingDirectory") + prop.getProperty("tagWordsTrainingFile_Software"));
		StringBuffer output = new StringBuffer();
		try {

			InputStream input = TagWords_TrainFile_Software.class.getResourceAsStream("/resources/" + file);
	...
	/*	
		...
		*/
		...
		Nasa_Main.setmap_software(map3);
		// System.out.println(map3.get("Aeronautics"));
