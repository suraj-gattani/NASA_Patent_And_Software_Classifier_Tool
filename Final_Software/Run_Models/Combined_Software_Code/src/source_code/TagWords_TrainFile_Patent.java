...
public class TagWords_TrainFile_Patent {
	...
	public static Map<Object, Set<String>> filter() throws Exception {
		...
		File file = new File(prop.getProperty("tagWordsTrainingFile_Patent"));
		File file1=new File(absPathFile.getAbsolutePath() + prop.getProperty("NasaWorkingDirectory") + prop.getProperty("tagWordsTrainingFile_Patent"));
		StringBuffer output = new StringBuffer();
		try {

			InputStream input = TagWords_TrainFile_Patent.class.getResourceAsStream("/resources/" + file);
